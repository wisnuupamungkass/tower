...
<header class="panel-heading"><center><h1>INPUT KECAMATAN</h1></header>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    ...
                    <label for="varchar" class="control-label col-lg-2">ID Kecamatan <span class="required">*</span></label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control" name="id_kecamatan" id="id_kecamatan" placeholder="ID Kecamatan" value="<?php echo $id_kecamatan; ?>" disabled>
                    </div>
                  </div>
								  <br>
								  <br>
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="nama_kecamatan" id="nama_kecamatan" placeholder="Nama Kecamatan" value="<?php echo set_value('nama_kecamatan') ?>" required/>
                    </div>
                  </div>
								  <br>
								  <br>

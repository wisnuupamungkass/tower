...
echo form_open_multipart('Site/edit/'.$id_site);
?>
<div><header class="panel-heading"><center><h1>EDIT SITE</h1></header></div>
<!-- Form Edit Site -->              
<div class="row">
  <div class="col-lg-12">
      <section class="panel">
			  	...
			  	<div class="form-group ">
					  ...
					  <div class="form-group ">
                         <label for="varchar" class="control-label col-lg-2">Longitude</label>
                          <div class="col-lg-9">
                              <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Longitude" value="<?php echo $longitude; ?>" required/>
                          </div>
                      </div>
					  <br>
					  <br>
					  ...
					  <div class="form-group ">
                         <label for="varchar" class="control-label col-lg-2">Lahan</label>
                          <div class="col-lg-9">
								<select  class="form-control" name="lahan" id="lahan" placeholder="Lahan" value="<?php echo $lahan; ?>">    

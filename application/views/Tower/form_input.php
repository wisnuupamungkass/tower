			  ...
			  <div class="alert alert-info fade in">
					  <div class="form-group ">
						 <label for="varchar" class="control-label col-lg-2"> ID Site <span class="required">*</span></label>
						  <div class="col-lg-9">
							  <input type="text" class="form-control" name="id_site" id="id_site" placeholder="ID Site" value="<?php echo set_value('nama_provider') ?>" required/>
						  </div>
					  </div>
					  <br>
					  <br>
					  ...
					  <div class="form-group ">
						 <label for="varchar" class="control-label col-lg-2">Tipe Menara <span class="required">*</span></label>
						  <div class="col-lg-9">
							<select  id="tipe_menara" name="tipe_menara" class="form-control" name="<?php echo set_value('tipe_menara') ?>">    
					  ...
					  <div class="form-group ">
						  ...
						  <div class="col-lg-9">
							  <input type="text" class="form-control" name="tinggi_menara" id="tinggi_menara" placeholder="Tinggi Menara" value="<?php echo set_value('tinggi_menara') ?>" required/>
						  </div>
					  </div>
					  <br>
					  <br>
					  ...
					  <div class="form-group ">
						  ...
						  <div class="col-lg-9">
							  <input type="text" class="form-control" name="eksisting_antena" id="eksisting_antena" placeholder="Eksisting Antena" value="<?php echo set_value('eksisting_antena') ?>" required/>
						  </div>
					  </div>
					  <br>
					  <br>
					  ...
					  <div class="form-group ">
						  ...
						  <div class="col-lg-9">
							  <input type="text" class="form-control" name="tinggi_antena" id="tinggi_antena" placeholder="Tinggi Antena" value="<?php echo set_value('tinggi_antena') ?>" required/>
						  </div>
					  </div>
					  <br>
					  <br>
					  ...
					  <div class="form-group ">
						  ...
						  <div class="col-lg-9">
                            <input type="file" name="userfile" class="form-control" value= "<?php echo set_value('foto_menara');?>" size="50">
                        </div>
					  </div>
					  <br>
					  <br>
